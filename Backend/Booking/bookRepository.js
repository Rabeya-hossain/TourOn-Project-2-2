...
class BookRepository extends Repository {
    ...
    booking = async (data) => {
        console.log("in bookRepository");
        console.log(data.check_outDate);

        let pdfDoc = new PDFDocument;
        pdfDoc.pipe(fs.createWriteStream('F:/HP/Documents/samplepdf.pdf'));
        pdfDoc
            .fillColor('blue')
            .fontSize(17)
            .text("Thank you for choosing TourOn", 150, 150);
       ...
       for(var r in HotelRooms){
        ...
        var mailOptions = {
            ...
            attachments: [{
                ...
                path: 'F:/HP/Documents/samplepdf.pdf',

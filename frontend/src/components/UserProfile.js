...
import {customer_id, nav, setLoginName} from "../App";
            ...
            <div >
                <div   className="row">
                    <div className="new-container">
                        <div   className="container row form-top">
                            ...
                            <div className="col-md-5 border-right">
                                <div className="p-3 py-5">
                                    ...
                                    <div className="row mt-4">
                                        <div className="col-md-12"><label className="labels">Mobile Number</label><input type="number"
                                                                                                                         style={{textAlign:"center"}}
                                                                                                                         className="form-control"
                                    ...
                                    <div className="row mt-3">
                                        <div className="col-md-6"><label className="labels">Country</label><input type="text"
                                                                                                                  ...
                                                                                                                  id="country"
                                        /></div>
                                        <div className="col-md-6"><label className="labels">city</label><input type="text"
                                                                                                               className="form-control"
                                                                                                               style={{textAlign:"center"}}
                                                                                                               placeholder="city"
                                                                                                               id="city"
                                        ...
                                        <div className="col-md-12"><label className="labels">Street Name</label><input type="text"
                                                                                                                       style={{textAlign:"center"}}
                                                                                                                       className="form-control"
                            ...
                            <div className="col-md-4">
                                <div className="p-3 py-5">
                                    <div className="mt-5 text-center">
                                        <button className="btn btn-primary profile-button" type="button" onClick={()=>{Click()}}>Save Profile</button>
                                    </div>
